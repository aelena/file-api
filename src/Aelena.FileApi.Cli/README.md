...
## Worked example: converting a mixed directory
...
[LICENSING.md](https://github.com/aelena/file-api/blob/main/LICENSING.md) for
why. `fileapi convert validate` on either says so in full, and the message on
